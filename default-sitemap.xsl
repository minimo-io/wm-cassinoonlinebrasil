...
>
	...
	<a href="https://cassinoonlinebrasil.com.br"><span>Início</span></a>
	...
	<a href="https://cassinoonlinebrasil.com.br"><span>Início</span></a>
			...
			<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
					...
					<a href="https://cassinoonlinebrasil.com.br/sitemap.xml"><span>Índice do sitemap</span></a>
						<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
	...
	<div id="content-head">
		...
		<xsl:choose>
			<xsl:when test="$fileType='RSS'">
				<p>Gerado por <a href="https://aioseo.com/?utm_source=WordPress&#038;utm_campaign=liteplugin&#038;utm_medium=xml-sitemap" target="_blank" rel="noreferrer noopener">All in One SEO</a>, este é um Sitemap RSS, destinado a ser consumido por mecanismos de pesquisa como Google ou Bing.</p>
				<p>
			...
			<xsl:otherwise>
				<p>Gerado por <a href="https://aioseo.com/?utm_source=WordPress&#038;utm_campaign=liteplugin&#038;utm_medium=xml-sitemap" target="_blank" rel="noreferrer noopener">All in One SEO</a>, este é um sitemap em XML, destinado a ser consumido por mecanismos de pesquisa como Google ou Bing.</p>
				<p>
		...
		<xsl:if test="$amountOfURLs &gt; 0">
			<p>
				...
				e foi gerado em outubro 29, 2025 às 8:48 pm			</p>
		</xsl:if>
	</div>
</xsl:template>
	...
	<a href="https://cassinoonlinebrasil.com.br"><span>Início</span></a>
		...
		<div class="empty-sitemap__buttons">
			<a href="https://cassinoonlinebrasil.com.br" class="button">Voltar à página inicial</a>
					</div>
